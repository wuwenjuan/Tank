...
void SneakyJoystick::onEnterTransitionDidFinish()
{
    ...
    listener->onTouchBegan = CC_CALLBACK_2(SneakyJoystick::ccTouchBegan, this);
    listener->onTouchMoved  =CC_CALLBACK_2(SneakyJoystick::ccTouchMoved, this);
    listener->onTouchEnded = CC_CALLBACK_2(SneakyJoystick::ccTouchEnded, this);
    listener->onTouchCancelled = CC_CALLBACK_2(SneakyJoystick::ccTouchCancelled, this);
